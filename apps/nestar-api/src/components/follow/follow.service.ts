...
export class FollowService {
	...
	public async subscribe(followerId: ObjectId, followingId: ObjectId): Promise<Follower> {
		...
		const targetMember = await this.memberService.getMember(null, followingId); //bunda biz subscribe bulmoqchi bulgan memberning(followingId) datalrini olmoqchimiz
	...
	private async registerSubscription(followerId: ObjectId, followingId: ObjectId): Promise<Follower> {
		try {
			return await this.followModel.create({
				followingId: followingId, //biz follow bulmoqchi bulgan memberning id.
				followerId: followerId, // bizning id (biz followermiz)
			});
		} catch (err) {
